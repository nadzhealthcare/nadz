...
export function PeptideTherapyClient({ data }) {
  return (
    <>
      ...
      <>
        ...
        {/* What Is Peptide Therapy Section */}
                ...
                <div className="relative w-full">
                  <div className="rounded-3xl overflow-hidden bg-white border border-gray-200 shadow-lg aspect-[4/3]">
                    <img
                      ...
                      alt={data.whatIs?.imageAlt || 'Peptide Therapy'}
        ...
        <section className="relative py-20 md:py-28 lg:py-32 bg-gray-50 overflow-hidden">
          <div className="container mx-auto max-w-7xl px-4 sm:px-6 md:px-8">
            ...
            {Array.isArray(data.whoCanBenefit?.items) && data.whoCanBenefit.items.length > 0 && (
              ...
              {data.journey.steps && data.journey.steps.map((step, index) => {
                ...
                return (
                  <div key={index} className="xl:relative xl:flex xl:items-center xl:justify-center">
                    ...
                    {Array.isArray(data.journey?.steps) && index < data.journey.steps.length - 1 && (
                      <svg 
        ...
        {data.faqs && (Array.isArray(data.faqs) ? data.faqs.length > 0 : (data.faqs?.items && data.faqs.items.length > 0)) && (
          <Faq
            title={data.faqs?.title || "FAQs – Peptide Therapy"}
