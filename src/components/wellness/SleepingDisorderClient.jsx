...
export function SleepingDisorderClient({ data }) {
  return (
    <>
      ...
      <>
          ...
          <div className="container mx-auto max-w-7xl px-4 sm:px-6 md:px-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 lg:gap-20 items-center">
              ...
              <div className="space-y-6 md:space-y-8">
                ...
                {data.whatIs.bullets && data.whatIs.bullets.length > 0 && (
                ...
                <div className="relative w-full">
                  <div className="rounded-3xl overflow-hidden bg-white border border-gray-200 shadow-lg aspect-[4/3]">
                    <img
                      ...
                      alt={data.whatIs?.imageAlt || 'Sleep Disorders Care'}
        ...
        {/* Who Can Benefit Section - CMS: whoCanBenefit */}
        {data.whoCanBenefit != null && (data.whoCanBenefit.title || (data.whoCanBenefit?.items?.length > 0) || data.whoCanBenefit?.footer) && (
        <section className="relative py-20 md:py-28 lg:py-32 bg-gray-50 overflow-hidden">
          <div className="container mx-auto max-w-7xl px-4 sm:px-6 md:px-8 flex flex-col items-center">
            ...
            {/* Two-column card grid (2x2 layout) - centered */}
            <div className="w-full max-w-5xl mx-auto">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-5 lg:gap-6">
                {(data.whoCanBenefit?.items ?? []).map((item, index) => (
                  <div key={index} className="bg-white rounded-[14px] border border-gray-200 shadow-sm hover:shadow-lg hover:border-primary-mediumBlue/40 p-4 md:p-5 transition-all duration-300 group">
                    <div className="flex items-start gap-3">
                      <div className="w-1.5 h-1.5 rounded-full bg-primary-mediumBlue flex-shrink-0 mt-2 group-hover:scale-125 transition-transform duration-300" />
              ...
              {data.whoCanBenefit?.footer && (
                <p className="text-center text-text-gray mt-8 md:mt-12 text-base md:text-lg max-w-3xl mx-auto">
                  {data.whoCanBenefit.footer}
                </p>
              )}
            </div>
        ...
        <section className="relative py-20 md:py-28 lg:py-32 bg-white overflow-hidden">
          <div className="container mx-auto max-w-7xl px-4 sm:px-6 md:px-8">
            ...
            <div className="flex items-center justify-center gap-2 md:gap-4 mb-8 sm:mb-12 md:mb-16">
              <div className="hidden md:flex flex-1 h-px bg-gray-300"></div>
              <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold leading-[1.1] sm:leading-tight tracking-tight text-center px-2 md:px-0">
                <span className="bg-gradient-to-r from-primary-heading via-primary-heading to-primary-heading bg-clip-text text-transparent">
                  {data.journey?.title}
                </span>
              </h2>
            ...
            {data.journey?.subtitle && (
              <p className="text-center text-base md:text-lg text-text-gray mb-8 md:mb-12 max-w-4xl mx-auto">
                {data.journey?.subtitle}
              </p>
            )}
              ...
              <div>
                ...
                >
                  <MotionDiv
                    ...
                    viewport={{ once: true }}
                    transition={{ duration: 0.6, delay: 0.2 }}
                    className="mb-4 sm:mb-5 text-left"
                  >
                    <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold leading-[1.1] sm:leading-tight tracking-tight mb-4 sm:mb-5">
                      <span className="bg-gradient-to-r from-primary-heading via-primary-heading to-primary-heading bg-clip-text text-transparent">
